...
const EVENTS: Event[] = [
  {
    ...
    description: "A two-day intensive coding bootcamp for students ages 12–18. Learn HTML, CSS, and JavaScript while building real projects.",
    date: "2026-04-19T09:00:00Z",
    location: "Innovation Hub, 45 Tech Ave",
    category: "workshop",
    isUpcoming: true,
  },
  {
  ...
  },
  {
    ...
    location: "Curiosity Project HQ, 123 Learning Lane",
    category: "volunteer",
    isUpcoming: true,
  },
  {
    id: 5,
    title: "Winter Reading Marathon",
    description: "Students pledged to read as many books as possible over winter break. Sponsors donated per book read, raising funds for our library program.",
    date: "2026-01-15T09:00:00Z",
    location: "Virtual & Libraries Citywide",
    category: "fundraiser",
    isUpcoming: false,
  },
  {
    ...
    description: "Professionals from tech, medicine, and engineering shared their journeys with 300+ students. A full day of mentorship and inspiration.",
                  ...
                  <div className="space-y-3 mb-6 bg-muted p-4 rounded-md">
                    <div className="flex items-center gap-3 text-sm text-foreground font-semibold">
                      ...
                      <span>
                        {(() => {
                          try {
                            return format(new Date(event.date), "MMMM d, yyyy • h:mm a");
                          } catch {
                            return event.date;
                          }
                        })()}
